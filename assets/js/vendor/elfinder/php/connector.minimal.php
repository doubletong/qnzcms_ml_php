...
$opts = array(
	...
	'roots' => array(
		...
		array(
			...
			'uploadAllow'   => array('image/x-ms-bmp', 'image/gif', 'image/jpeg', 'image/png', 'image/x-icon', 'image/svg+xml', 'video/mp4', 'application/pdf','text/plain'), // Mimetype `image` and `text/plain` allowed to upload
		...
		array(
			...
			'uploadAllow'   => array('image/x-ms-bmp', 'image/gif', 'image/jpeg', 'image/png', 'image/x-icon', 'image/svg+xml', 'video/mp4', 'application/pdf', 'text/plain'), // Same as above

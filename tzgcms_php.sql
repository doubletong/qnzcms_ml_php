...
--
-- Host: localhost:3306
-- Generation Time: Jan 14, 2020 at 08:32 PM
...
(2, '格科微电子  用芯看世界', 'http://www.baidu.com', '/uploads/images/carousels/banner01.jpg', '/uploads/images/carousels/banner01.jpg', '<p>aa</p>\r\n', '', 0, 2, 1, 'admin', '2019-12-30 05:47:45', '2020-01-14 01:27:20'),
(3, 'test', 'http://www.baidu.com', '/uploads/images/carousels/banner01.jpg', '/uploads/images/carousels/banner01.jpg', '', '', 0, 2, 1, 'admin', '2019-12-31 10:26:07', '2020-01-14 01:27:32'),
(4, 'test123', 'http://www.baidu.com', '/uploads/images/carousels/banner01.jpg', '/uploads/images/carousels/banner01.jpg', '', '', 0, 2, 1, 'admin', '2019-12-31 10:28:07', '2020-01-14 01:27:43');
...
(18, '解决方案', '', '/solution', 0, 80, 32, 1),
(39, '法律声明', '', '/statement/legal', 0, 0, 40, 1),
(40, '免责声明', '', '/statement/policy', 0, 0, 40, 1),
(41, '联系格科', '', '/about/contact', 0, 0, 40, 1),
(46, '关于格科', '', '/about', 0, 150, 32, 1),
(47, '新闻中心', '', '/news', 0, 0, 32, 1),
(48, '联系我们', '', '/about/contact', 46, 1, 32, 1),
(49, '技术支持', '', '/support', 0, 0, 32, 1),
(50, '移动设备', '', '/application/index-1', 8, 10, 32, 1),
(51, '汽车电子', '', '/application/index-3', 8, 7, 32, 1),
(55, '公司简介', '', '/about', 46, 5, 32, 1),
(56, '发展历程', '', '/about/history', 46, 3, 32, 1),
(71, 'USB camera', '', '/application/index-4', 8, 6, 32, 1),
(72, 'DDI', '', '/products/index?cid=1', 13, 1, 32, 1),
(91, '首页', '', '/', 0, 180, 32, 1),
(92, '企业荣誉', '', '/about/honor', 46, 2, 32, 1),
...
(127, '安防监控', '', '/application/index-2', 8, 8, 32, 1),
(128, 'ISF', '', '/products/index?cid=3', 13, 1, 32, 1),
(129, 'CIS', '', '/products/index?cid=2', 13, 5, 32, 1),
(130, '智慧屏电视', '', '/application/index-5', 8, 0, 32, 1),
(131, '生物识别&扫码', '', '/application/index-6', 8, 0, 32, 1);
...
(55, '免责声明', 'policy', 0, '<p>格科微电子（上海）有限公司及其全球的关联公司（下文简称&ldquo;格科&rdquo;、&ldquo;我们&rdquo;和&ldquo;我们的&rdquo;）深知隐私对您的重要性，并会尊重您的隐私。请在向格科提交个人数据之前，阅读、了解本《隐私政策》（下文简称&ldquo;本政策&rdquo;）。本政策适用于显示本隐私政策、或链接至本隐私政策的格科网站和产品、服务。</p>\r\n\r\n<p>本政策阐述了格科如何处理您的个人数据，但本政策可能并不涉及所有可能的数据处理情境。有关收集产品或服务特定数据的信息可能由格科在补充政策中，或者在收集数据时提供的通知中发布。</p>\r\n\r\n<p>我们制定本政策的目的在于帮助您了解以下内容：</p>\r\n\r\n<ol>\r\n	<li>格科如何收集和使用您的个人数据</li>\r\n	<li>格科如何使用 Cookie&nbsp;</li>\r\n	<li>格科如何披露您的个人数据</li>\r\n	<li>如何访问或修改您的个人数据</li>\r\n	<li>格科如何保护您的个人数据</li>\r\n	<li>格科如何处理未成年人的个人数据</li>\r\n	<li>第三方提供商及其服务</li>\r\n	<li>本政策如何更新</li>\r\n</ol>\r\n\r\n<h3>1. 格科如何收集和使用您的个人数据</h3>\r\n\r\n<p>个人数据是指单独使用或结合其他信息使用时能够确定个人身份的信息。此类数据会在您使用我们的网站、产品或服务，以及与我们互动时由您直接提交给我们，例如，当您创建格科账户或[重建官网是否会增加该项功能？如无，相关表述删除即可。]联系我们获得支持时；或者我们通过记录您如何与我们的网站、产品或服务交互而获得，例如，通过Cookie等技术，或者从您设备上运行的软件接收使用数据。我们收集的数据取决于您与格科互动的方式，包括访问的网站等，包括电子邮箱、登录信息（帐号和密码）等。</p>\r\n\r\n<p>我们可能将您的个人数据用于以下目的：</p>\r\n\r\n<dl>\r\n	<dd>(a) 创建账户。</dd>\r\n	<dd>(b) 为您提供个性化用户体验和个性化内容。</dd>\r\n	<dd>(c) 开展内部审计、数据分析和研究，改善我们的产品和服务。</dd>\r\n	<dd>(d) 在您选择向我们发送错误详情的情况下排查错误。</dd>\r\n	<dd>(e) 同步、共享和存储您上传或下载的数据以及执行上传和下载所需的数据。</dd>\r\n	<dd>(f) 保护我们产品、服务和客户或用户的安全，执行与改善我们的防损和反欺诈计划。</dd>\r\n	<dd>(g) 遵从和执行适用的法律要求，相关的行业标准或我们的政策。</dd>\r\n</dl>\r\n\r\n<p>格科还可能收集和使用非识别性数据。非识别性数据是指无法用于确定个人身份的数据。例如，格科会收集汇总的统计数据，例如网站访问量。格科收集此数据的目的在于了解用户如何使用自己的网站、产品和服务。借此，格科可以改善自己的服务、更好地满足客户需求。格科可能会自行决定出于其他目的收集、使用、处理、转移或披露非识别性数据。我们会尽力隔离您的个人数据和非识别性数据，并单独使用这两种数据。</p>\r\n\r\n<p>如果个人数据掺杂了非识别性数据，依旧会被视作个人数据处理。</p>\r\n\r\n<p>当格科处理您的个人数据时我们会遵从适用的法律的要求基于适当的合法性基础予以处理，包括：</p>\r\n\r\n<ul>\r\n	<li>当响应您的交易或服务请求时为履行合同处理您的个人数据；</li>\r\n	<li>基于您的同意处理您的个人数据；</li>\r\n	<li>当与您联系、进行营销或市场调查，为改善我们的产品和服务，执行与改善我们的防损和反欺诈计划等目的处理您的个人数据时我们将基于我们或第三方的合法利益。这些合法利益包括，使我们能够更有效的管理和运营我们的业务并提供我们的产品和服务；保护我们的业务、系统、产品、服务和客户的安全；内部管理，遵从内部的政策和流程；我们在本政策中描述的其他合法利益等；</li>\r\n	<li>我们还可能基于遵从和执行法律义务处理您的个人数据。</li>\r\n</ul>\r\n\r\n<h3>2. 格科如何使用 Cookie&nbsp;</h3>\r\n\r\n<p>Cookie 是一种网络服务器存储在计算机或移动设备上的纯文本文。Cookie 的内容只能由创建它的服务器检索或读取。每个 Cookie 对您的网络浏览器或移动应用程序都是唯一的。Cookie 通常包含标识符、站点名称以及一些号码和字符。格科启用Cookie的目的与大多数网站或互联网服务提供商启用 Cookie 的目的一样，即改善用户体验。借助于 Cookie，网站能够记住用户的单次访问（使用会话 Cookie）或多次访问（使用永久 Cookie）。借助于 Cookie，网站能够保存设置，例如计算机或移动设备的语言、字体大小和其他浏览偏好。这意味着，用户无需在每次访问时重新配置用户偏好设置。格科不会将 Cookie 用于本政策所述目的之外的任何用途。</p>\r\n\r\n<h3>3. 格科如何披露您的个人数据</h3>\r\n\r\n<p>在某些服务由格科的授权合作伙伴提供的情况下，格科会如本政策描述与该合作伙伴共享您的个人数据。在适用的法律要求或响应法律程序的情况下，格科也可能会向相关的执法机关或者其他政府机关披露您的个人数据。在某些管辖区，如果格科牵涉到重组、合并或破产和清理诉讼，那么您的个人数据还可能会被披露给交易方。格科还会在存在合理需求的情况下披露您的数据，例如出于执行合同以及我们认为为阻止身体损害或财产损失或调查可能的或实际的非法行为有必要披露且披露是适当的。</p>\r\n\r\n<h3>4.&nbsp;如何访问或修改您的个人数据</h3>\r\n\r\n<p>您应确保提交的所有个人数据都准确无误。格科会尽力维护个人数据的准确和完整，并及时更新这些数据。</p>\r\n\r\n<p>当适用的法律要求的情况下，您可能(1)有权访问我们持有的关于您的特定的个人数据；(2)要求我们更新或更正您的不准确的个人数据；(3)拒绝或限制我们使用您的个人数据；以及(4)要求我们删除您的个人数据。如果您想行使相关的权利，请反馈给我们。为保障安全，您可能需要提供书面请求。如果我们有合理依据认为这些请求存在欺骗性、无法实行或损害他人隐私权，我们则会拒绝处理请求。</p>\r\n\r\n<p>当适用的法律要求的情况下，当格科基于您的同意处理您的个人数据时，您还有权随时撤销您的同意。但撤销同意不会影响撤销前我们基于您的同意处理您个人数据的合法性及效力，也不影响我们基于其他适当的正当性基础处理您的个人数据。</p>\r\n\r\n<h3>5.&nbsp;格科如何保护和留存您的个人数据[请市场部注意是否有相关措施。</h3>\r\n\r\n<p>格科重视个人数据的安全。我们采用适当的物理、管理和技术保障措施来保护您的个人数据不被未经授权访问、披露、使用、修改、损坏或丢失。例如，我们会使用加密技术确保数据的机密性；我们会使用保护机制防止数据遭到恶意攻击；我们会部署访问控制机制，确保只有授权人员才可访问个人数据；以及我们会举办安全和隐私保护培训课程，加强员工对于保护个人数据重要性的认识。我们会尽力保护您的个人数据，但是请注意任何安全措施都无法做到百分之百安全。</p>\r\n\r\n<p>我们将会在达成本政策所述目的所需的期限内保留您的个人数据，除非按照法律要求或许可需要延长保留期或受到法律的允许。因为基于不同的场景和产品及服务的不同，数据的存储期可能会有所不同，我们用于确定存留期的标准包括：完成该业务目的需要留存个人数据的时间，应对可能的用户查询或投诉，问题定位等；用户是否同意更长的留存期间；法律、合同等是否有保留数据的特殊要求等。只要您的账户是为您提供服务必须，我们都将保留您的注册信息。您也可以选择注销您的账号，在您注销账号后，我们会停止基于该账号提供产品和服务，并在无特殊法律要求的情况下，删除您相应的个人数据。</p>\r\n\r\n<h3>6.&nbsp;格科如何处理未成年人的个人数据</h3>\r\n\r\n<p>我们的产品、网站和服务主要面向成人。如果没有父母或监护人的同意，未成年人不得创建自己的用户帐户。对于经父母同意而收集未成年人个人数据的情况，我们只会在受到法律允许、父母或监护人明确同意或者保护未成年人所必要的情况下使用或披露此数据。 如果格科发现在未事先获得可证实的父母同意的情况下收集了未成年人的个人数据，则会设法尽快删除相关数据。</p>\r\n\r\n<h3>7.&nbsp;第三方提供商及其服务</h3>\r\n\r\n<p>为确保流畅的浏览体验，您可能会收到来自格科及其合作伙伴外部的第三方（下文简称&ldquo;第三方&rdquo;）提供的内容或网络链接。格科对此类第三方无控制权。您可选择是否访问第三方提供的链接、内容、产品和服务。</p>\r\n\r\n<p>格科无法控制第三方的隐私和数据保护政策，此类第三方不受到本政策的约束。在向第三方提交个人信息之前，请参见这些第三方的隐私保护政策。</p>\r\n\r\n<h3>8.&nbsp;本政策如何更新</h3>\r\n\r\n<p>格科保留不时更新或修改本政策的权利。如果我们的隐私政策变更，我们会将最新版隐私政策发布在这里。如果我们对隐私政策做出了重大变更，我们还可能会通过不同渠道向您发送变更通知，例如，在我们的网站上发布通知或者向您发布单独的通知。</p>\r\n\r\n<p>最近更新日期：2019年12月</p>\r\n', '', 6, 1, 'admin', 1578927703, '', ''),
(56, '法律声明', 'legal', 0, '<h3>不承诺责任声明</h3>\r\n\r\n<p>格科微电子（上海）有限公司（以下简称&ldquo;本公司&rdquo;或&ldquo;格科&rdquo;）已真诚地于本网页提供阁下所需材料和信息，包括但不限于文本、图片、数据、观点、建议、网页或链接，惟仅供参考，而并不保证这些材料和内容的准确、完整、充分和可靠性，并且明确声明不对这些材料和内容的错误或遗漏承担责任，也不对这些材料和内容作出任何明示或默示的、包括但不限于有关所有权担保、没有侵犯第三方权利、质量和没有计算机病毒的保证。</p>\r\n\r\n<p>格科可以在没有任何通知或提示的情况下随时对本网站上的内容进行修改，为了得到最新版本的信息，请定时访问本网站。</p>\r\n\r\n<p>格科在本网站上所提及的非格科产品或服务仅仅是为了提供相关信息，并不构成对这些产品、服务的认可或推荐。 格科并不就网址上提供的任何产品、服务或信息做出任何声明、保证或认可，所有销售的产品和服务应受本公司的销售合同和条款的约束。</p>\r\n\r\n<h3>著作权说明</h3>\r\n\r\n<p>本网站所载的所有材料或内容受版权法的保护，所有版权由格科拥有，但注明引用第三方的内容除外。未经格科或第三方事先书面同意，任何人不得将本网站上的任何内容以任何方式进行复制、经销、翻印、播放、以超级链接连接或传送、以&quot;镜像法&quot;载入其他服务器上、存储于信息检索系统或者其他任何商业目的的使用，但对于非商业目的的、个人使用的下载或打印（条件是不得修改，且须保留该材料中的版权说明或其他所有权的说明）除外。</p>\r\n\r\n<h3>商标说明</h3>\r\n\r\n<p>本网站上使用和显示的所有商标、标志皆属格科所有，但注明属于第三方拥有的商标、标志、商号除外。格科网站所载的任何内容不应被视作未经格科或第三方书面许可，以暗示、不反对或其他形式授予使用前述任何商标、标志的许可或权利。未经事先书面许可，任何人不得以任何方式使用上述名称、商标、标记。</p>\r\n\r\n<h3>第三方链接</h3>\r\n\r\n<p>本网站可能保留有与第三方网站或网址的链接，访问这些链接将由访问者自己作出决定，格科并不保证这些链接上所提供的任何信息、数据、观点、图片、陈述或建议的准确性、完整性、充分性和可靠性。格科提供这些链接仅仅在于提供方便，并不表示格科对这些信息的认可和推荐，也不是用于宣传或广告目的。</p>\r\n', '', 4, 1, 'admin', 1578927744, '', '');
...
(2, 'CIS', '', '', '', 0, '', b'1', 0, 1561968662, 0),
(5, 'DDI', '', '', '', 0, '', b'1', 0, 1561970696, 0),
(6, 'ISF', '', '', '', 0, '<p>dsa</p>\r\n', b'1', 0, 1578650714, 0);
...
INSERT INTO `product_categories_v1` (`id`, `title`, `parent`, `importance`, `active`, `added_by`, `created_at`, `updated_at`) VALUES
(1, 'DDI', NULL, 0, 1, 'admin', '2020-01-10 16:00:00', '2020-01-10 16:00:00'),
(2, 'CIS', NULL, 10, 1, 'admin', '2020-01-12 05:21:19', '2020-01-12 05:24:59'),
(3, 'ISF', NULL, 0, 1, 'admin', '2020-01-12 05:23:20', '2020-01-12 05:24:49'),
(4, '800万-1300万像素', 2, 0, 1, 'admin', '2020-01-12 05:26:55', '2020-01-12 05:26:55'),
(5, '200万-500万像素', 2, 0, 1, 'admin', '2020-01-12 05:27:18', '2020-01-12 06:31:03'),
(6, '100万像素以下', 2, 0, 1, 'admin', '2020-01-12 05:27:42', '2020-01-12 05:27:42'),
(7, 'HD/HD+', 1, 0, 1, 'admin', '2020-01-12 06:29:47', '2020-01-12 06:29:47'),
(8, 'WVGA/FW', 1, 0, 1, 'admin', '2020-01-12 06:29:57', '2020-01-12 06:29:57'),
(9, 'LQVGA', 1, 0, 1, 'admin', '2020-01-12 06:30:11', '2020-01-12 06:30:11'),
(10, 'QVGA', 1, 0, 1, 'admin', '2020-01-12 06:30:22', '2020-01-12 06:30:22'),
(11, 'QCIF', 1, 0, 1, 'admin', '2020-01-12 06:30:34', '2020-01-12 06:30:34'),
...
--
-- Indexes for table `product_categories_v1`
--
ALTER TABLE `product_categories_v1`
  ADD PRIMARY KEY (`id`),
...
--
-- AUTO_INCREMENT for table `products_v1`
--
ALTER TABLE `products_v1`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
...
--
-- AUTO_INCREMENT for table `product_categories_v1`
--
ALTER TABLE `product_categories_v1`
...
--
-- Constraints for table `products_v1`
--
ALTER TABLE `products_v1`
  ADD CONSTRAINT `products_v1_category_id_foreign` FOREIGN KEY (`category_id`) REFERENCES `product_categories_v1` (`id`) ON DELETE CASCADE;

--
-- Constraints for table `product_categories_v1`
--
ALTER TABLE `product_categories_v1`
  ADD CONSTRAINT `product_categories_v1_parent_foreign` FOREIGN KEY (`parent`) REFERENCES `product_categories_v1` (`id`);
COMMIT;

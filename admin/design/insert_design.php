      ...
      <div class="container-fluid">
		...
		<div class="container-fluid">
              ...
              if (filled_out($_POST))   {
                ...
                if(insert_design($title,$description,$demourl,$categoryid)) {              
                   	echo '<div class="alert alert-success">';
					echo '<button type="button" class="close" data-dismiss="alert">&times;</button>';
					echo '<i class="icon-ok-sign"></i> 案例“'.$title.'”已被添加数据库。</div>';
                } else {             
                  	echo '<div class="alert alert-error">';
					echo '<button type="button" class="close" data-dismiss="alert">&times;</button>';
   					echo '<i class="icon-remove-sign"></i> 案例"'.$title.'"没有添加成功。</div>';
                }
              } else {

<?php
 ...
 do_html_doctype("正添加案例_案例_网站管理_".SITENAME);
  do_html_header();
  ?>
  ...
  if (filled_out($_POST))   {
    ...
    if(insert_case($title,$description,$demourl,$categoryid)) {
      echo "<p class=\"yes\">案例\"".$title."\"已被添加数据库。</p>";
    } else {
      echo "<p class=\"error\">案例\"".$title."\"没有添加成功。</p>";
    }
  } else {

...
if($site_info['enableCaching']=="1"){
    ...
    if (!$CachedString->isHit()) {
        ...
        $metadata = Metadata::where('module_type',ModuleType::PRODUCT())->where('key_value',$id)->first();       

        $news_detail_data = ['product' => $data,  'metadata' => $metadata];
    ...
    $result =  ['product' => $data, 'metadata' => $metadata];

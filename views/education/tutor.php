...
function loadDate($lang,$menus){
    ...
    if(isset($research)){
        $teachers = explode('|', $research->teachers);        
        $teams = Team::where('active',1)->whereIn('id',$teachers)->where('lang',$lang)->orderBy('importance','DESC')->get();      
    }
    ...
    return  ['subnavs' => $subnavs, 'metadata'=>$metadata,'carousel'=>$carousel,'researches'=> $researches, 'research'=>$research, 'teachers'=>$teams ];
}
...
echo $twig->render('education/tutor.html', $result);

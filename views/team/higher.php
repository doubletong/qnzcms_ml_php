...
$cid = 3;
$urlPattern = $lang=='zh-CN'? '/team/higher/page-(:num)' : '/'.$lang.'/team/higher/page-(:num)';
...
function loadDate($lang,$menus,$query,$itemsPerPage,$currentPage,$urlPattern,$cid){   
    ...
    if(isset($_GET['fl'])){    
        ...
        $urlPattern = $lang=='zh-CN'? '/team/higher/'.$fl.'/page-(:num)' : '/'.$lang.'/team/higher/'.$fl.'/page-(:num)';
    }

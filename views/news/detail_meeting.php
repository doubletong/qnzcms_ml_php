...
function loadDate($menus,$lang,$id){
    ...
    $metadata = Metadata::where('module_type',ModuleType::EVENT())->where('key_value',$id)->first();       
    ...
    return  ['event' => $data, 'subnavs' => $subnavs, 'metadata'=>$metadata,'carousel'=>$carousel];
}

$uri = $lang=='zh-CN'?'/news/meeting':'/'.$lang.'/news/meeting';
...
echo $twig->render('news/detail_meeting.html', $result);

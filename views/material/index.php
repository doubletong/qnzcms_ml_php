...
if($site_info['enableCaching']=="1"){
    ...
    if (!$CachedString->isHit()) {
        ...
        $home_data = ['paginator' => $paginator,'products'=>$products,'product'=>$product,'pageIndex'=>$pageIndex,'productId'=>$product_id];
    ...
    $result = ['paginator' => $paginator,'products'=>$products,'product'=>$product,'pageIndex'=>$pageIndex,'productId'=>$product_id];
}

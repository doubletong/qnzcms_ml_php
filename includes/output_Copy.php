...
<head>
    ...
    <link rel="stylesheet" href="<?php echo SITEPATH ?>/assets/css/bootstrap.min.css">

    <link href="assets/style.css" rel="stylesheet" />
    <link href="assets/css/animate.css" rel="stylesheet" />
    <link rel="stylesheet" href="<?php echo SITEPATH ?>/assets/css/main.css">
    <script src="<?php echo SITEPATH ?>/js/modernizr-2.8.3.js"></script>
    <!--[if lt IE 9]>
    <script src="<?php echo SITEPATH ?>/js/lib/respond.min.js"></script>
    <![endif]-->
    <!--[if (gte IE 6)&(lte IE 8)]>
    <script type="text/javascript" src="<?php echo SITEPATH ?>/js/lib/nwmatcher-1.2.5-min.js"></script>
    <script type="text/javascript" src="<?php echo SITEPATH ?>/js/lib/selectivizr-min.js"></script>
    <![endif]-->
<?php 
}
...
<header class="container">
    <div class="row page-header">
        <div class="logo">
            <a href="/"><img src="assets/img/logo.png" alt="洁碧" /></a>
        </div>
        <div class="shippingCart">
          <a href="shoppingCart.php"><i class="icon-shopping-cart"></i><span class="hidden-xs"> 购物车</span>(<span id="totalItems"><?php  print_r($_SESSION['total_items']);?></span>)</a>
        </div>
    ...
    <section class="container botNav">
        <div class="row">
            <div class="col-md-6">
                <div class="row">
                    <div class="col-xs-7">
                        <a href="marketing.php" class="box bg_navy">
                    ...
                    <div class="col-xs-5">
                        <div class="map" aria-hidden="true">
                            <a href="marketing.php"><i class="icon-earth"></i></a>
                        </div>
            ...
            <div class="col-md-6">
                <div class="row">
                    <div class="col-xs-7">
                        <a href="service.php" class="box bg_gray box_right">
                    ...
                    <div class="col-xs-5">
                        <div class="woman" aria-hidden="true">
                            <a href="service.php"><i class="icon-wrench"></i></a>
                        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-6 col-md-pull-6">
                <div class="row">
                    <div class="col-xs-7">
                        <a href="about.php" class="box bg_gray">
                    ...
                    <div class="col-xs-5">
                        <div class="man" aria-hidden="true">
                            <a href="about.php"><i class="icon-droplet"></i></a>
                        </div>
                    </div>
                </div>
            </div>

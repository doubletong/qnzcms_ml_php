...
if(isset($data['dictionary_id'])){
    ...
    $categories = $categoryClass->fetch_all($data['dictionary_id']);
...
<head>
    <title><?php echo $pageTitle."_专业项目_后台管理_" .$site_info['sitename']; ?></title>
            ...
            <div class="container-fluid maincontent">
                <form novalidate="novalidate" id="editform">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <input id="majorId" type="hidden" name="majorId" value="<?php echo isset($data['id'])?$data['id']:0; ?>" />
                            ...
                            <div class="row">
                                ...
                                <div class="col-auto">
                                    <div style="width:300px;  text-align:center;" class="mb-3">
                                        <div class="card">
                                            <div class="card-body">                                           
                                                <img ID="iLogo" src="<?php echo empty($data['image_url']) ? "holder.js/240x310?text=148X207像素" : $data['image_url']; ?>" class="img-fluid" />
    ...
    <script type="text/javascript">
        ...
        //    alert("dddd");
            ...
            $("#dictionary_id").on('change', function() {
               var did = $(this).val();
                $.getJSON("major_helper.php?did=" + did, function(data){
                    //console.log(data)
                    var result = "";

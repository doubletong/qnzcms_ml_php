                                ...
                                <div style="width:300px;  text-align:center;" class="mb-3">
                                        ...
                                        <div class="card-header">封面</div>
                                            ...
                                            <div class="card-footer">
                                                <button type="button" id="btnPoster" class="btn btn-info"><i class="fa fa-picture-o"></i> 浏览...</button>
                                                <?php if(!empty($data['poster'])){ ?>
                                                <button type="button" id="btnImgDelete" class="btn btn-danger"><i class="iconfont icon-delete"></i> 移除</button>
                                            <?php } ?>
                                                <input id="poster" type="hidden" name="poster" value="<?php echo isset($data['poster'])?$data['poster']:''; ?>" />
                                            </div>
                                        </div>
                                    </div>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $("#btnPoster").on("click", function () {
                singleEelFinder.selectActionFunction = SetPoster;

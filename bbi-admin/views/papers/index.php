...
$urlPattern = "index.php?page=(:num)";
 ...
 $Paper = new Paper;
 //搜索条件判断
 $query = $Paper->select('id','content', 'thumbnail','lang', 'importance','active','pubdate');
...
<head>
    <title><?php echo "论文_后台管理_" . $site_info['sitename']; ?></title>
            ...
            <div class="main-content"> 
                ...
                <div class="card">
                    <header class="card-header">
                        <div class="row">
                            <div class="col">
                                <div class="card-title-v1"> <i class="iconfont icon-file"></i>论文列表</div>
                            </div>
                            <div class="col-auto">
                    ...
                    <div class="card-toolbar mb-3">
                        ...
                        <div class="row">
                            ...
                            <div class="col-auto">
                                <a href="Paper_edit.php" class="btn btn-primary">               
                    ...
                    <div class="table-responsive">                 
                        <table class="table table-hover table-bordered table-striped box-table">
                            ...
                            foreach($countries as $row)
                            {
                                echo "<tr>";
                            ?>
                            <td><img src="<?php echo $row['thumbnail'];?>" class="img-rounded" style="height:80px;"/></td>
                                ...
                                <td><a href='Paper_edit.php?id=<?php echo $row['id'];?>' class='btn btn-primary btn-sm'>

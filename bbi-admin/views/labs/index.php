...
$exhClass = new Lab;
 //搜索条件判断
$query = $exhClass->select('id','title','lang','thumbnail','importance','view_count','active');
        ...
        <div class="main-content"> 
                ...
                <div class="row">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="/bbi-admin/views/pages/index.php">实验室</a></li>
            ...
            <div class="card">
                <header class="card-header">
                    <div class="row">
                        <div class="col">
                            <div class="card-title-v1"> <i class="iconfont icon-reddit"></i>实验室</div>
                        </div>
                        <div class="col-auto">

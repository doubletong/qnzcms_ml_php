...
$urlPattern = "regions.php?page=(:num)";
 //文章表实例化
 $region = new Region;
 //搜索条件判断
 $query = $region;
...
$regions = $query->orderBy('importance', 'DESC')
...
<head>
    <title><?php echo "区域_后台管理_" . SITENAME; ?></title>
    ...
    <div class="wrapper">
        ...
        <section class="rightcol">
            ...
            <div class="row">
                ...
                <div class="col-auto">
                    <a href="region_edit.php" class="btn btn-primary">               
            ...
            <table class="table table-hover table-bordered table-striped">
                ...
                ?>
                    ...
                    <td><a href='region_edit.php?id=<?php echo $row['id'];?>' class='btn btn-primary btn-sm'>

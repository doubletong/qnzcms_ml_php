...
$totalItems = $annalClass->get_annals_count($did, $keyword);  //总记录数
...
$annals = $annalClass->get_paged_annals($did, $keyword, $currentPage, $itemsPerPage);
        ...
        <section class="rightcol">
            ...
            <div class="container-fluid maincontent">
                ...
                <div class="row">
                    ...
                    <div class="col-auto">
                        <a href="annal_edit.php?did=<?php echo $did; ?>" class="btn btn-primary">
                ...
                <table class="table table-hover table-bordered">
                    ...
                    <tbody>
                        ...
                        foreach ($annals as $row) {
                            ...
                            <td><a href='annal_edit.php?id=<?php echo $row['id']; ?>' class='btn btn-primary btn-sm'>

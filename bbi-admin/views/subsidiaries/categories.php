...
//文章表实例化
$categoryClass = new SubsidiaryCategory;
//搜索条件判断
...
<head>
    <title>
        <?php echo "成员企业_后台管理_" . $site_info['sitename']; ?>
    </title>
            ...
            <div class="main-content"> 
                    ...
                    <div class="row">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">行业分类</li>
                            </ol>
                        </nav>
                        </div>
                ...
                <div class="card">
                    <header class="card-header">
                        <div class="row">
                            <div class="col">
                                <div class="card-title-v1"> <i class="iconfont icon-appstore-fill"></i>行业分类</div>
                            </div>
                            <div class="col-auto">

...
if (isset($_GET['id'])) {
    $id = $_GET['id'];    
    $data = SubsidiaryCategory::find($id);    
...
<head>
    <title><?php echo $pageTitle . "_成员企业_后台管理_" . $site_info['sitename']; ?></title>
...
<body>
                    ...
                    <div class="row">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="categories.php">行业分类</a></li>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $(".mainmenu>li.li57").addClass("nav-open").find("ul>li.li58 a").addClass("active");

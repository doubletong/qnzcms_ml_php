...
$categoryClass = new TZGCMS\Admin\Country();
...
$totalItems = $categoryClass->get_countries_count($keyword);  //总记录数
...
$countries = $categoryClass->get_paged_countries($keyword, $currentPage, $itemsPerPage);
...
<html>
<head>
    <title><?php echo "国家_ 专业项目 _后台管理_".$site_info['sitename'];?></title>
            ...
            <div class="row">
                ...
                <div class="col-auto">
                    <a href="country_edit.php" class="btn btn-primary">               
                        <i class="iconfont icon-plus"></i>  添加国家                        
                    </a>
                </div>
            </div>
                ...
                ?>
                    <!-- <td>
                        <?php if(!empty($row['thumbnail'])){ ?> 
                            <img src="<?php echo $row['thumbnail'] ;?>" alt="<?php echo $row['name'] ;?>" style="max-height:50px;display:block;">
                        <?php } ?>
                    </td>  -->
                    ...
                    <td><a href='category_edit.php?id=<?php echo $row['id'];?>' class='btn btn-primary btn-sm'>
...
<script>
    $(document).ready(function () {
        //当前菜单
        $(".mainmenu>li.schools").addClass("nav-open").find("ul>li.category a").addClass("active");

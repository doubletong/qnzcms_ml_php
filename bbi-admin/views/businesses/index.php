...
$urlPattern = "index.php?page=(:num)";
 //文章表实例化
 $articles = new Business;

 $query = $articles->with(['category' => function ($query) {
    $query->select('id', 'title');
}])->select('id','title', 'image_url','lang', 'category_id','importance','active','created_at');
...
if(isset($_REQUEST["cid"]) && $_REQUEST["cid"] != ""){
    ...
    $querycateogries = SubsidiaryCategory::where('parent','=',$cid)->orwhere('id','=',$cid)->select('id')->get();
...
<head>
    <title><?php echo "业务领域_后台管理_" . $site_info['sitename']; ?></title>
...
<body>
            ...
            <div class="main-content"> 
                    ...
                    <div class="row">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="/bbi-admin/views/businesses/index.php">业务领域</a></li>
                ...
                <div class="card">
                    <header class="card-header">
                        <div class="row">
                            <div class="col">
                                <div class="card-title-v1"> <i class="iconfont icon-file-copy"></i>业务领域</div>
                            </div>
                            <div class="col-auto">
                    ...
                    <div class="card-toolbar mb-3">
                        ...
                        <div class="row">
                            ...
                            <div class="col-auto">
                                <a href="business_edit.php" class="btn btn-primary">               
                    ...
                    <div class="table-responsive">                 
                        <table class="table table-hover table-bordered table-striped box-table">
                            ...
                            <tr>          
                                ...
                                <th>
                                    <?php if($orderby=='created_at'){ ?>
                                        <a href="index.php?keyword=<?php echo $keyword; ?>&cid=<?php echo $cid; ?>&orderby=created_at&sort=<?php echo $sort=='asc'?'desc':'asc';?>">发布日期<i class="iconfont icon-order-<?php echo $sort=='asc'?'up':'down';?>"></i></a>
                                    <?php }else{ ?>
                                        <a href="index.php?keyword=<?php echo $keyword; ?>&cid=<?php echo $cid; ?>&orderby=created_at&sort=asc">发布日期<i class="iconfont icon-orderby"></i></a>
                                    <?php } ?>
                                </th>
                                <th>语言</th>
                                <th>状态</th>
                            ...
                            <td><img src="<?php echo $row['image_url'];?>" class="img-rounded" style="height:35px;"/></td>
                                ...
                                <td><?php echo date_format(date_create($row['created_at']),"Y-m-d");?></td>
                                ...
                                <td><a href='business_edit.php?id=<?php echo $row['id'];?>' class='btn btn-primary btn-sm'>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $(".mainmenu>li.business").addClass("nav-open").find("ul>li.list a").addClass("active");     
            //确认框默认语言
            bootbox.setDefaults({
                locale: "zh_CN"
            });

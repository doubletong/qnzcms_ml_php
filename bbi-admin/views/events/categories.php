...
<head>
    <title><?php echo "分类_活动事件_后台管理_" . $site_info['sitename']; ?></title>
...
<body>
            ...
            <div class="main-content"> 
                    ...
                    <div class="row">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="/bbi-admin/views/news/index.php">活动事件</a></li>
                ...
                <div class="card">
                    <header class="card-header">
                        <div class="row">
                            <div class="col">
                                <div class="card-title-v1"> <i class="iconfont icon-link"></i>活动分类</div>
                            </div>
                            <div class="col-auto">
                    ...
                    <footer class="card-footer">
                            ...
                            <div class="text-right">
                                总记<strong><?php echo EventCategory::count(); ?></strong>条记录
                            </div>
    ...
    <script>
        $(document).ready(function () {
            ...
            $(".mainmenu>li.events").addClass("nav-open").find("ul>li.category a").addClass("active");

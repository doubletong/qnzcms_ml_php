                ...
                <form>
                    <div class="card">
                        <div class="card-header">
                            <div class="card-title-v1"><i class="iconfont icon-edit"></i>
                                <?php echo $pageTitle . "分类"; ?></div>
                        </div>
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" id="importance" name="importance"
                                    value="<?php echo isset($data['importance']) ? $data['importance'] : '0'; ?>"
                                    placeholder="">
                            </div>
                            <!--   
                            <div class="form-group">
                        ...
                        <div class="card-footer text-center">
                            ...
                            <a href="JavaScript:window.history.back()" class="btn btn-outline-secondary"><i

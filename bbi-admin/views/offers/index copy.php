...
$totalItems = $majorClass->get_majors_count_v1($did,$cid, $keyword);  //总记录数
$itemsPerPage = 10;  // 每页显示数
$currentPage = isset($_GET['page']) ? $_GET['page'] : 1; // 当前所在页数

$paginator = new Paginator($totalItems, $itemsPerPage, $currentPage, $urlPattern);
$paginator->setMaxPagesToShow(6);
$majors = $majorClass->get_paged_majors_v1($did, $cid, $keyword, $currentPage, $itemsPerPage);
   ...
   <?php require_once($_SERVER['DOCUMENT_ROOT'] . '/bbi-admin/includes/nav.php'); ?>
        ...
        <div class="container-fluid maincontent">
            <div class="row mb-2">
                ...
                <div class="col-auto">
                        <a href="major_edit.php" class="btn btn-primary">
                            <i class="iconfont icon-plus"></i>  添加专业
                        </a>
                </div>
            </div>
            <table class="table table-hover table-bordered table-striped">
                ...
                ?>
                    ...
                    <td>
                        ...
                        <a href='major_edit.php?id=<?php echo $row['id'];?>&did=<?php echo $row['dictionary_id'];?>' class='btn btn-primary btn-sm' title="编辑">
...
<script>
    $(document).ready(function () {
        //当前菜单  
        $(".mainmenu>li.majors").addClass("nav-open").find("ul>li:nth-of-type(1) a").addClass("active");
        ...
        $(".btn-delete").click(function(){
            ...
            bootbox.confirm("删除后新闻将无法恢复，您确定要删除吗？", function (result) {
                if (result) {
                    ...
                    $.ajax({
                        url : 'major_actions.php',
                        type : 'POST',
                        data : {id:majorId,action:"delete"},
        ...
        $(".btn-recommend").click(function(){
            ...
            $.ajax({
                url : 'major_actions.php',
                type : 'POST',
                data : {id:majorId,action:"recommend"},
                success : function(res) {                                                   
                    var myobj = JSON.parse(res);                    

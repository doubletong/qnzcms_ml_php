...
//文章表实例化
$categoryClass = new LinkCategory;
//搜索条件判断
$query = $categoryClass->select('id','title','importance','active','created_at');
...
<head>
    <title>
        <?php echo "链接_后台管理_" . $site_info['sitename']; ?>
    </title>
...
<body>
            ...
            <div class="main-content"> 
                    ...
                    <div class="row">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="index.php">链接</a></li>
                ...
                <div class="card">
                    <header class="card-header">
                        <div class="row">
                            <div class="col">
                                <div class="card-title-v1"> <i class="iconfont icon-link"></i>链接分类</div>
                            </div>
                            <div class="col-auto">
    ...
    <script>
        $(document).ready(function() {
            ...
            $(".mainmenu>li.links").addClass("nav-open").find("ul>li.categories a").addClass("active");

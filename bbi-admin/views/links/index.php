...
$urlPattern = "index.php?page=(:num)";
 ...
 $link = new Link;
 //搜索条件判断
 $query = $link->with(['category' => function ($query) {
    $query->select('id', 'title');
}])->select('id','title', 'image_url', 'url', 'lang', 'category_id','importance','active','created_at');
...
<head>
    <title><?php echo "链接_后台管理_" . $site_info['sitename']; ?></title>
...
<body>
            ...
            <div class="main-content"> 
                    ...
                    <div class="row">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="#">链接</a></li>
                ...
                <div class="card">
                    <header class="card-header">
                        <div class="row">
                            <div class="col">
                                <div class="card-title-v1"> <i class="iconfont icon-link"></i>链接</div>
                            </div>
                            <div class="col-auto">
                            ...
                            <table class="table table-hover table-bordered table-striped box-table">
                                ...
                                <tr>          
                                    ...
                                    <th>
                                        <?php if($orderby=='title'){ ?>
                                            <a href="index.php?keyword=<?php echo $keyword; ?>&orderby=title&sort=<?php echo $sort=='asc'?'desc':'asc';?>">主题<i class="iconfont icon-order-<?php echo $sort=='asc'?'up':'down';?>"></i></a>
                                        <?php }else{ ?>
                                            <a href="index.php?keyword=<?php echo $keyword; ?>&orderby=title&sort=asc">主题<i class="iconfont icon-orderby"></i></a>
                                        <?php } ?>   
                                    </th>
                                    <th>分类</th>                              
                                    <th>链接</th>
                                ...
                                <td>
                                    <?php if(!empty($row['image_url'])){ ?>
                                        <img src="<?php echo $row['image_url'];?>" class="img-rounded" style="height:35px;"/>
                                    <?php }?>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $(".mainmenu>li.links").addClass("nav-open").find("ul>li.list a").addClass("active");     
            //确认框默认语言
            bootbox.setDefaults({
                locale: "zh_CN"
            });

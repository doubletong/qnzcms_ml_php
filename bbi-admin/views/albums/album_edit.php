...
$pageTitle = isset($_GET['id']) ? "编辑相册" : "创建相册";
...
<head>
    <title><?php echo $pageTitle . "_相册_后台管理_" . $site_info['sitename']; ?></title>
...
<body>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            //当前菜单
            $(".mainmenu>li.albums").addClass("nav-open").find("ul>li:nth-of-type(2) a").addClass("active");

...
$albums = $query->orderBy('importance', 'DESC')
...
<head>
    <title>
        <?php echo "相册_后台管理_" . $site_info['sitename']; ?>
    </title>
...
<body>
            ...
            <div class="main-content"> 
                    ...
                    <div class="row">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">相册集合</li>
                            </ol>
                        </nav>
                        </div>
                ...
                <div class="card">
                    <header class="card-header">
                        <div class="row">
                            <div class="col">
                                <div class="card-title-v1"> <i class="iconfont icon-image"></i>相册集合</div>
                            </div>
                            <div class="col-auto">
                    ...
                    <section class="card-body">
                        <div class="card-toolbar mb-3">
                            ...
                            <div class="row">
                                ...
                                <div class="col-auto">
                                    <a href="album_edit.php" class="btn btn-primary">
                                ...
                                <tbody>
                                    ...
                                    foreach ($albums as $row) {
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href='album_edit.php?id=<?php echo $row['id']; ?>' class='btn btn-primary btn-sm' title="编辑">
    ...
    <script>
        $(document).ready(function() {
            ...
            $(".mainmenu>li.albums").addClass("nav-open").find("ul>li.list a").addClass("active");

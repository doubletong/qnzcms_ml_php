...
//文章表实例化
$categoryClass = new SocialSoftware;
//搜索条件判断
$query = $categoryClass->select('id','name','icon','iconfont','importance','active','created_at');
...
<head>
    <title>
        <?php echo "社交管理_后台管理_" . $site_info['sitename']; ?>
    </title>
            ...
            <div class="main-content"> 
                    ...
                    <div class="row">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">社交类型</li>
                            </ol>
                        </nav>
                        </div>
                ...
                <div class="card">
                    <header class="card-header">
                        <div class="row">
                            <div class="col">
                                <div class="card-title-v1"> <i class="iconfont icon-weibo"></i>社交类型</div>
                            </div>
                            <div class="col-auto">
                    ...
                    <section class="card-body">
                        <div class="card-toolbar mb-3">
                            ...
                            <div class="row">
                                ...
                                <div class="col-auto">
                                    <a href="software_edit.php" class="btn btn-primary">
                            ...
                            <table class="table table-hover table-bordered table-striped box-table">
                                <thead>
                                    <tr>
                                        ...
                                        <th>
                                        <?php if($orderby=='name'){ ?>
                                        <a href="categories.php?keyword=<?php echo $keyword; ?>&orderby=name&sort=<?php echo $sort=='asc'?'desc':'asc';?>">标题<i class="iconfont icon-order-<?php echo $sort=='asc'?'up':'down';?>"></i></a>
                                    <?php }else{ ?>
                                        <a href="categories.php?keyword=<?php echo $keyword; ?>&orderby=name&sort=asc">标题<i class="iconfont icon-orderby"></i></a>
                                    <?php } ?>        
                                        </th>
                                        <th>字体图标</th>                        
                                        <th>
                                ...
                                <tbody>
                                    ...
                                    foreach ($categorys as $row) {
                                        ...
                                        ?>
                                        <tr>
                                            <td><img src="<?php echo $row['icon']; ?>" alt=""></td>         
                                            <td><?php echo $row['name']; ?></td>
                                            <td><?php echo $row['iconfont']; ?></td>                              
                                            ...
                                            <td>
                                                <a href='software_edit.php?id=<?php echo $row['id']; ?>' class='btn btn-primary btn-sm' title="编辑">

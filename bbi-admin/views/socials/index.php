...
$urlPattern = "index.php?page=(:num)";
 //文章表实例化
 $download = new SocialAccount;
 //搜索条件判断
 $query = $download->with(['socialSoftware' => function ($query) {
    $query->select('id', 'name');
}])->select('id','username', 'qrcode', 'url', 'social_id','importance','active','created_at');
            ...
            <div class="main-content"> 
                    ...
                    <div class="row">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">社交帐号</li>
                            </ol>
                        </nav>
                        </div>
                ...
                <div class="card">
                    <header class="card-header">
                        <div class="row">
                            <div class="col">
                                <div class="card-title-v1"> <i class="iconfont icon-weibo"></i>社交帐号</div>
                            </div>
                            <div class="col-auto">
                    ...
                    <section class="card-body">
                        <div class="card-toolbar mb-3">
                            <div class="row">
                                ...
                                <div class="col-auto">
                                    <a href="account_edit.php" class="btn btn-primary">               
                            ...
                            <table class="table table-hover table-bordered table-striped box-table">
                                ...
                                <tr>          
                                    ...
                                    <?php if($orderby=='username'){ ?>
                                        <a href="index.php?keyword=<?php echo $keyword; ?>&orderby=username&sort=<?php echo $sort=='asc'?'desc':'asc';?>">标题<i class="iconfont icon-order-<?php echo $sort=='asc'?'up':'down';?>"></i></a>
                                    <?php }else{ ?>
                                        <a href="index.php?keyword=<?php echo $keyword; ?>&orderby=username&sort=asc">标题<i class="iconfont icon-orderby"></i></a>
                                    <?php } ?>     
                                    </th>
                                    <th>链接</th>
                                    <th>分类</th>
                                ...
                                ?>
                                    ...
                                    <td><?php echo $row['socialSoftware']['name'] ;?></td>                               
                                    <td><img src="<?php echo $row['qrcode'];?>" class="img-rounded" style="height:50px;"/></td>
                                    <td><?php echo $row['importance'] ;?></td>         
                                    <td><?php echo date_format($row['created_at'],"Y-m-d");?></td>
                                    <td><?php echo ($row['active']==1)?"显示":"隐藏" ;?></td>
                                    <td><a href='account_edit.php?id=<?php echo $row['id'];?>' class='btn btn-primary btn-sm'>

            ...
            <div class="panel-body">
                <form class="form-horizontal" style="position: relative;" novalidate="novalidate">
                    <div style="width:180px; position:absolute;right:0;top:0;z-index:100; text-align:center;">
                        <div class="panel panel-default">
                            <div class="panel-body">
                                <img ID="iLogo" src="holder.js/150x100/text:295X333像素" class="img-responsive img-rounded" />
                            </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">
                            <input type="text" class="form-control" id="product_no" name="product_no" placeholder="">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">
                            <div class="input-group">
                                <input id="background" name="background"  class="form-control" placeholder="背景图"></asp:TextBox>
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-2 col-sm-10">
                            <div class="checkbox">
                                <label>
                                    <input type="checkbox" name="recommend"> 推荐首页
                                </label>
                            </div>
                        </div>
                    </div>

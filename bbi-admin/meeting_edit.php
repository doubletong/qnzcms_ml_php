...
<html>
<head>
    <title><?php echo "编辑_会议信息_后台管理_".SITENAME;?></title>
...
<div class="wrapper">
    ...
    <section class="rightcol">            
        ...
        <div class="card-body">
                <input id="meetingId" type="hidden" name="meetingId" value="<?php echo $data["id"];?>" />
                <div class="row">
                    <div class="col">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" id="sponsor" name="sponsor" value="<?php echo $data["sponsor"];?>" type="text" />                        
                        </div>

                        <div class="form-group">
                            <label for="co_organizer">协办单位</label>
                            <input class="form-control" id="co_organizer" name="co_organizer" value="<?php echo $data["co_organizer"];?>" type="text" />                        
                        </div>
                    
                        <div class="form-group">
                            <label for="meeting_time">会议时间</label>
                            <input class="form-control" id="meeting_time" name="meeting_time" value="<?php echo $data["meeting_time"];?>"  type="text" />                        
                        </div>

                        <div class="form-group">
                            <label for="address">会议地点</label>
                            <input class="form-control" id="address" name="address" value="<?php echo $data["address"];?>" type="text" />                        
                        </div>
                    ...
                    <div class="col-auto">
                        <div style="width:300px; text-align:center;" class="mb-3">
                            <div class="card">
                                <div class="card-body">
                                    <img ID="iLogo" src="<?php echo empty($data['thumbnail'])?"holder.js/240x180?text=540X350像素":$data['thumbnail'];?>" class="img-fluid" />
            ...
            submitHandler: function(form) {
                ...
                $.ajax({
                    ...
                    success : function(res) {
                        ...
                        if (res) {
                            toastr.success('新闻已编辑成功！', '编辑会议信息')
                        } else {

                            toastr.error('新闻编辑失败！', '编辑会议信息')
                        }
                    }
                });

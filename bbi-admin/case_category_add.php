...
<html>
<head>
    <title><?php echo "创建分类_案例_后台管理_".SITENAME;?></title>
                ...
                <div class="form-group">
                    ...
                    <div class="col-auto">
                        <div style="width:300px; text-align:center;" class="mb-3">
                            <div class="card">
                                <div class="card-body">
                                    <img ID="iLogo" src="holder.js/240x240?text=240X240像素" class="img-responsive img-rounded" />
                                </div>
            ...
            submitHandler: function(form) {
                ...
                $.ajax({
                    ...
                    success : function(res) {
                        ...
                        if (res) {
                            toastr.success('案例分类已添加成功！', '添加案例分类')
                        } else {

                            toastr.error('案例分类添加失败！', '添加案例分类')
                        }
                    }
                });

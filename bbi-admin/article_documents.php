...
if(isset($_GET['aid'])){
    ...
    $documents = $docClass->get_all($aid);
...
<head>
    <title><?php echo "文章附件_后台管理_" . SITENAME; ?></title>
            ...
            <div class="container-fluid maincontent">
                ...
                <div class="card mb-3">
                    ...
                    <div class="row">
                        ...
                        <input id="article_id" type="hidden" name="article_id" value="<?php echo $aid; ?>" />
            ...
            $(".btn-delete").click(function() {
                ...
                bootbox.confirm("删除后文档将无法恢复，您确定要删除吗？", function(result) {
                    if (result) {
                        ...
                        $.ajax({
                            url: 'article_document_delete.php',
                            type: 'POST',
                            data: {
                                id: documentId
                            },

...
<!--main-->
    <div class="main">
        ...
        <div class="about_item about_item_02 fff" style="">
            <div class="wrap">
                <h2 class="about_title wow fadeInUp">微创®在全球</h2>
                <div class="about_desc wow fadeInUp">
                    <p>微创®总部位于中国上海张江科学城，在中国上海、苏州、嘉兴、东莞，美国孟菲斯，法国巴黎近郊，意大利米兰近郊和多米尼加共和国等地均建有主要生产（研发）基地，形成了全球化的研发、生产、营销和服务网络。</p>
                </div>
            </div>
        ...
        <div class="about_item about_item_04 fff" style="background-image:url(images/about_04.jpg)">
            <div class="wrap">
                ...
                <div class="about_desc wow fadeInUp">
                    <p>微创®的产品已进入全球近万家医院，覆盖亚太、欧洲和美洲等主要地区。<br/>
                        在全球范围内，平均每8秒就有一个微创®的产品被用于救治患者生命<br/>
                        或改善其生活品质或用于帮助其催生新的生命。</p>
                    <p>2014年推出的药物靶向洗脱支架系统更是令微创®在冠脉支架领域完成了<br/>
            ...
            <div class="wrap">
                ...
                <div class="about_desc wow fadeInUp">
                    <p>微创®专注于自主创新并一以贯之高强度投资于研发，<br/>
                        ...
                        微创®尊崇循证医学，几乎所有核心产品与解决方案的临床应用效果（经验）<br/>
                        都在全球主流学术杂志上得到了发表。</p>
                </div>
            </div>
        </div>
        ...
        <ul class="about_other_list">
            <li class="clear">
                ...
                <div class="txt fr wow fadeInUp">
                    ...
                    <h2>以人为本</h2>
                    <p>以人为本，在以微创伤为代表的高科技医学领域<br/>建设一个属于患者的全球化领先医疗集团</p>
                </div>
            </li>
            <li class="clear">
                ...
                <div class="txt fl wow fadeInUp">
                    ...
                    <span class="line"></span>
                    <h2>持续创新</h2>
                    <p>持续创新，为医生提供能挽救并重塑患者生命或改善<br/>其生活质量的真善美惠医疗解决方案
                    </p>
                </div>
            </li>
        </ul>

                ...
                <div class="tab-container ">
                    <ul class="tabs-header wow slideInUp">
                        <?php foreach ($categories as $category) { ?>
                            <li><a href="#slide<?php echo $category['id']; ?>"><?php echo $category['title']; ?></a></li>
                        <?php   } ?>
                    ...
                    <div class="swiper-container homeapps wow slideInUp">
                        <div class="swiper-wrapper">
                            ...
                            <?php foreach ($categories as $category) { ?>
                                <div class="swiper-slide" data-hash="slide<?php echo $category['id']; ?>" style="background-image:url('<?php echo $category['thumbnail']; ?>');">
                                    <div class="txt">
